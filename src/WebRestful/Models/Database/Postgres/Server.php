...
class Server extends ModelServer
{
    ...
    {
        return PostgresBase::query($this->serverName, $mvc, $modelName, $tableName, $this->sql, $this->data, $this->data_bind, $this->keyName, $this->offset, $this->limit, $this->query_pass);
    }
