<p align="center"><a href="#" target="_blank"><img src="https://github.com/Homeeat/Pocoapoco/blob/main/src/Image/Pocoapoco_white.png" alt="Pocoapoco" width="500"></a></p>
<br>
<p align="center">
...
server {
        listen 60000;
        root   /{where you do composer}/pocoapoco/web/{web_basic}/public/;
        ...
        location /NTCH/ {
            ...
            location ~ \.php$ {
                ...
                fastcgi_param PROJECT_ROOT /{where you do composer}/pocoapoco/web/{web_basic}/;
            }
        }
        location / {
